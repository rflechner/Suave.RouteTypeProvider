...
let project = "Suave.RouteTypeProvider"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "A Type Provider helping to create strongly typed routes like WebApi format"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A Type Provider helping to create strongly typed routes like WebApi format"

// List of author names (for NuGet package)
let authors = [ "rflechner" ]

// Tags for your project (for NuGet package)
let tags = "suave typeprovider"

// File system information
let solutionFile  = "Suave.RouteTypeProvider.sln"
...
let gitName = "Suave.RouteTypeProvider"
