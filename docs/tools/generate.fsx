...
let website = "/Suave.RouteTypeProvider"

let githubLink = "http://github.com/rflechner/Suave.RouteTypeProvider"

// Specify more information about your project
let info =
  [ "project-name", "Suave.RouteTypeProvider"
    "project-author", "rflechner"
    "project-summary", "A Type Provider helping to create strongly typed routes like WebApi format"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Suave.RouteTypeProvider" ]
